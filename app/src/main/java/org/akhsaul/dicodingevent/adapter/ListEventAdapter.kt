...
class ListEventAdapter(private val listener: OnItemClickListener) :
    ListAdapter<Event, ListEventAdapter.MyViewHolder>(DiffCallback) {

    class MyViewHolder(private val binding: ItemEventBinding, private val context: Context) :
